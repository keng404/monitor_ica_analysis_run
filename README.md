...
You can use the docker image  ```keng404/monitor_ica_analysis_run:0.0.1``` [](https://hub.docker.com/repository/docker/keng404/monitor_ica_analysis_run/tags?page=1&ordering=last_updated) with all the appropriate scripts and libraries installed
